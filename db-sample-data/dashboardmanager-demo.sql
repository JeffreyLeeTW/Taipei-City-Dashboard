...
food_inspection_map	{#2B8CBE,#7BCCC4,#A8DDB5,#FDD49E,#FDBB84,#FC8D59,#D7301F,#7F0000,#756BB1,#31A354,#636363,#9E9AC8,#8DD3C7,#BEBADA,#FB8072,#80B1D3,#FDB462,#B3DE69,#FCCDE5,#D9D9D9,#BC80BD,#CCEBC5,#FFED6F,#1B9E77,#D95F02,#7570B3,#E7298A,#66A61E,#E6AB02,#A6761D,#666666}	{DistrictChart,ColumnChart}	件
food_inspection_two_d_district_pass	{#56B96D,#8BCF74,#2E7D32,#A5D6A7,#66BB6A,#43A047,#9CCC65,#7CB342,#C5E1A5,#388E3C,#689F38,#AED581}	{BarChart,ColumnChart}	件
...
232	food_inspection_map	食品抽驗地區分布
240	food_inspection_two_d_district_pass	食品抽驗合格量（行政區分布）
...
food_inspection_map	\N	\N	{}	static	\N	0	\N	臺北市/新北市政府資料開放平台	食品抽驗地區分布	食品抽驗地區分布，依需求輸出 x_axis / data。	可直接作為 query_charts raw SQL，供前端對應圖表型態渲染與比對。	{}	{doit}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	two_d	select district as x_axis, sum(count)::int as data from public.food_inspection where city='臺北市' group by district order by district	\N	taipei
food_inspection_map	\N	\N	{}	static	\N	0	\N	臺北市/新北市政府資料開放平台	食品抽驗地區分布	食品抽驗地區分布，依需求輸出 x_axis / data。	可直接作為 query_charts raw SQL，供前端對應圖表型態渲染與比對。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	two_d	select district as x_axis, sum(count)::int as data from public.food_inspection group by district order by district	\N	metrotaipei
food_inspection_two_d_district_pass	\N	\N	{}	static	\N	0	\N	臺北市/新北市政府資料開放平台	食品抽驗合格量（行政區分布）	食品抽驗合格量（行政區分布），依需求輸出 x_axis / data。	可直接作為 query_charts raw SQL，供前端對應圖表型態渲染與比對。	{}	{doit}	2026-05-03 00:00:00+00	2026-05-03 00:00:00+00	two_d	select district as x_axis, sum(count)::int as data from public.food_inspection where city='臺北市' and result = true group by district order by district	\N	taipei
